...
if __name__ == '__main__':
    ...
    lr = 5e-5
    weight_decay = 0.01
    vocab_path = '/home/aistudio/b/chinese_L-12_H-768_A-12/vocab.txt'

    train_file = '/home/aistudio/pseudo_7.tsv'
    predict_file = '/home/aistudio/pre.tsv'
    config = json.load(open('/home/aistudio/b/chinese_L-12_H-768_A-12/bert_config.json'))
    ...
    save_path = './outputs13/'
    pred_output = './outputs13/predict/'
    save_type = 'ckpt'
    print_steps = 100
    pre_params = '/home/aistudio/b/chinese_L-12_H-768_A-12/params'
    ...
    model_path = './outputs/ckpt.step'+str(161730)
