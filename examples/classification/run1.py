...
if __name__ == '__main__':
    ...
    lr = 5e-5
    weight_decay = 0.01
    vocab_path = '/home/aistudio/ernie_base/vocab.txt'

    train_file = '/home/aistudio/pseudo_7.tsv'
    predict_file = '/home/aistudio/pre.tsv'
    config = json.load(open('/home/aistudio/ernie_base/ernie_config.json'))
    ...
    save_type = 'ckpt'
    print_steps = 100
    pre_params = '/home/aistudio/ernie_base/params'
    ...
    model_path = './outputs/ckpt.step'+str(186888)
